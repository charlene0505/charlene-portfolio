...
export const columns = [
  ...
  },
  {
    ...
    name: "Education",
    subtitle:
      "Graduate studies in Sydney, undergrad in Shanghai, one semester in the US.",
    layout: "education",
    items: [
      {
...
• Active in TEDxUNSW and the Software Development Society Subcommittee, and reached the semi-final of the Peter Farrell Cup Pitch Competition.`,
      },
      {
        ...
        tags: [
          ...
          "National Student Innovation Contest",
        ],
        images: [],
    ...
    items: [
      {
        ...
        embed: "color-book",
        desc: [
          "A coloring book for the digital age with a bit of riso txture built in.",
          "Patterns are original and will be updated irregularly (usually when I'm craving for the peace coloring brings)",
          "Please feel free to color it just like you did as a kid.",
          "Enjoy, and be careful about the black.",
        ],
      },
      // {
      //   name: "24ish",
